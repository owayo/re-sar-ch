...
| ベンチ | 時間 | スループット |
|---|---:|---:|
| ヘッダ解析のみ (`Auto` = read) | 66 µs | 13.8 GiB/s |
| ヘッダ解析のみ (`mmap` 強制) | 178 µs | 5.1 GiB/s |
| レコード境界の走査のみ | 9.3 µs | 98 GiB/s |
| 全 activity デコード | 270 µs | 3.4 GiB/s |
| CPU のみデコード | 97 µs | 9.4 GiB/s |
